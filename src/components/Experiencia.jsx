...
//<section className='w-9/12 mx-auto flex flex-col gap-10 my-[50px]'>
  ...
  return (
    <section className={visible ? ' w-9/12 mx-auto flex flex-col gap-10 my-[50px] animate__animated animate__fadeIn sm:w-11/12 sm:h-[550px] sx:h-[550px] sx:my-5 overflow-x-hidden' : 'w-9/12 mx-auto flex flex-col gap-10 my-[50px] animate__animated animate__fadeOut opacity-0 sm:w-11/12' }>
      <div className='flex gap-5 items-center'>
        <h1 className='text-secondary text-4xl sm:text-2xl'>Experiencia</h1>
        <span className='w-52 h-0.5 bg-tertiary sm:w-44'></span>
      </div>
      <div className='flex sm:flex-col overflow-x-hidden'>
        ...
        <div className='w-3/4 flex ml-5 sm:w-full sx:w-full'>
