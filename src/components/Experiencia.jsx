...
//<section className='w-9/12 mx-auto flex flex-col gap-10 my-[50px]'>
  ...
  return (
    <section className={visible ? ' w-9/12 mx-auto flex flex-col gap-10 my-[50px] animate__animated animate__fadeIn sm:w-11/12 sm:h-[550px] sx:h-[550px] sx:my-5': 'w-9/12 mx-auto flex flex-col gap-10 my-[50px] animate__animated animate__fadeOut opacity-0 sm:w-11/12' }>
