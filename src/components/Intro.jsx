...
const Intro = () => {
  ...
  return (
    <section className='w-9/12 mx-auto h-[90vh] flex flex-col justify-center gap-10 animate__animated animate__fadeIn sm:w-11/12 sm:my-5 sx:gap-5 overflow-x-hidden'>
